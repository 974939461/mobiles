...
<script type="text/javascript">
      $(function(){
    	    $("#btn_n").click(function(){
    	    	var a=$("#txt_name").val();
    	    	var b=$("#txt_birthday").val();
    	    	var c=$("#txt_address").val();
    	    	if(a==""||b==""||c==""){
    	    	     alert("数据不能为空");	
    	    	}else
    	    		$("form").submit();	
...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="Customer2.do">
      <p>证件类型：${t.idType }</p><input type="hidden" name="idType" value="${t.idType }">
      <p>证件号码：${t.idInt }</p><input type="hidden" name="idInt" value="${t.idInt }">
      <p>姓名：<input type="text" id="txt_name" name="customerName" size="20" value=""></p>
      <p>性别：<input type="radio" value="V1" checked name="customerSex">男&nbsp;&nbsp; <input type="radio" name="customerSex" value="V2">女</p>
      <p>生日：<input type="text" id="txt_birthday" name="customerBirtyday" size="20" value="1965/1/1"></p>
      <p>联系地址：<input type="text" id="txt_address"  name="customerAddress" size="20" value=""></p>
      <p>　</p>
      <p><input type="button" id="btn_n" value="下一步>>" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>
