...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="Customer1.do">
      <p>证件类型：<select size="1" name="idType">
        <option>居民身份证</option>
        <option>护照</option>
        <option>军官证</option>
      </select></p>
      <p>证件号码：<input type="text" id="txt_cardid" name="idInt" size="20" value=""></p>
      
      <p>　</p>
      <p><input type="button" id="btn_next"value="下一步>>" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>
